...
public class RankMovies {
   ...
   static String rankings(String messageDisplay, List<TextChannel> channelList) {
      ...
      // and can keep adding more boxes onto the end at any time (and removing
      ...
      while (!movies.isEmpty()) {
         ...
         //First we check that we have a valid movie
         if(highestIndex != -1) {
      ...
      //Finally we use the .toString() method of our StringBuilder to send the
      // final movie rankings to the channel that the command was sent in
